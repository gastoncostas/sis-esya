// Funcionalidad específica para la página de formación de agentes
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (developmentBtn) {
        developmentBtn.addEventListener('click', function(e) {
            e.preventDefault();
            alert('Esta funcionalidad se encuentra actualmente en desarrollo y estará disponible próximamente.');
        });
    }
